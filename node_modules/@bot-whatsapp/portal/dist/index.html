...
<head q:head>
    ...
    <title q:head>🤖 chatbot WhatsApp</title>
...
<body lang="en"><!--qv q:id=4 q:key=AKet:pq_1--><!--qv q:id=5 q:key=dyI7:-->
        ...
        <header class="⭐️csou2o-0">
            <div class="⭐️csou2o-0 logo"><a href="https://github.com/codigoencasa/bot-whatsapp" target="_blank"
                    ...
                    <div class="⭐️ef2ac2-0 logo"><img width="40" height="40"
                            ...
                            alt class="⭐️ef2ac2-0">
                        <h1 class="⭐️ef2ac2-0">Plantilla</h1>
                    </div><!--/qv-->
                </a></div>
            <ul class="⭐️csou2o-0">
        </header><!--/qv-->
    ...
    <footer><a href="https://qwik.builder.io/" target="_blank">Made with <strong>DialogoBot</strong></a></footer>
    <!--/qv--><!--/qv-->
</body><!--/qv--><!--/qv--><!--/qv-->
<script
